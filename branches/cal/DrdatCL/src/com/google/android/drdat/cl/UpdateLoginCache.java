...
public class UpdateLoginCache {
	...
	public UpdateLoginCache(Activity a) {
		activity = a;
		prefs = activity.getSharedPreferences(activity.getString(R.string.UpdateLoginFile), Context.MODE_PRIVATE);
		edPrefs = prefs.edit();
	...
	public UpdateLoginCache(Activity a, String em, String pw) {
		activity = a;
		email = em;
		password = pw;
